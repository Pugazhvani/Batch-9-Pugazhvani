...
function createAccount(){
    ...
    $(".favHero:checked").each(function(){
        user.favHero.push($(this).val());
    });
    usersList.push(user);
    userIdCount++;
    console.log(usersList);
        ...
        if(isUserLoggedIn === true){
            ...
            if(loggedInUserDetails.isAdmin){
                ...
                for(k = 0; k < usersList.length; k++) {
                    ...
                    "<button onclick='openEditUserModal(this)'>Edit</button>   <button onclick='deleteUser(this)'>Delete</button></td></tr>");
                }
            } else {
